...
const data = {
    ...
    rows: [
        ...
        },
        {
            ...
            content: "If you own a property and want to sell it, Register as a Buyer and if you want to buy a property, Register as a Buyer.",
        },
        {
            title: "Why can't I request for a property Property after registering as Buyer?",
            content: "Your account profile and documents will first be verified by the property Inspector and then you can request a property.",
        },
        {
            title: "Why can't I add a property Property after registering as Seller?",
