...
class Addproperty extends Component {
  ...
  addproperty = async () => {
    ...
    if (this.state.area == '' || this.state.city == '' || this.state.stateLoc == '' || this.state.price == '' || this.state.propertyPID == '' || this.state.surveyNum == '') {
      ...
      alert("property area and Price of property must be a number!");
    } else {
      await this.state.propertyInstance.methods.addproperty(
        this.state.area,
        this.state.city,
        this.state.stateLoc,
        this.state.price, 
  ...
  // _city,string  _state, uint propertyPrice, uint _propertyPID,uint _surveyNum,string memory _ipfsHash
      ...
      <div className="content">
        <Row>
          <Col md="8">
            <Card>
              <CardHeader>
                <h5 className="title">Add property</h5>
              </CardHeader>
              <CardBody>
                <Form>
                  <Row>
                  ...
                  <Row>
                    <Col md="12">
                      <FormGroup>
                        <label>Insert property Image</label>
                        <FormFile
                          id="File1"
              ...
              <CardFooter>
                <Button className="btn-fill" color="primary" onClick={this.addproperty}>
                  Add property
                </Button>
              </CardFooter>
            </Card>
