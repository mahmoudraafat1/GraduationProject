...
class LIDashboard extends Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            sellerarr.push(<ContractData contract="property" method="getSellersCount" />);
            buyerarr.push(<ContractData contract="property" method="getBuyersCount" />);
                    ...
                    <div className="content">
                        ...
                        <Col lg="4">
                            ...
                            <Col lg="4">
                                <Card>
                                    <CardHeader>
                                        <h5 className="title">property Transfer Requests</h5>
                                    </CardHeader>
                                    <CardBody>
                                        <div className="chart-area">

                                            <Button href="/LI/TransactionInfo" className="btn-fill" color="primary">
                                                Approve property Transactions
                        </Button>
                                        </div>
                                    </CardBody>
                                </Card>
