...
class updateBuyer extends Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            var buyer_verify = await this.state.propertyInstance.methods.isVerified(currentAddress).call();
            ...
            buyer = await this.state.propertyInstance.methods.getBuyerDetails(currentAddress).call();
            console.log(buyer);
            console.log(buyer[0]);
    ...
    updateBuyer = async () => {
      if (this.state.name == '' || this.state.age == '' || this.state.city == '' || this.state.email == '' || this.state.aadharNumber == '' || this.state.panNumber == '') {
          ...
          await this.state.propertyInstance.methods.updateBuyer(
              this.state.name,
              this.state.age,
              this.state.city,
