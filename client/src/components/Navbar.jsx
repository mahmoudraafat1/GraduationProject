...
const Navbar = () => {
  ...
  return (
    ...
    <div className="text-4xl inline-flex items-center">
      ...
      >
        <h2 className="text-yellow-300 mb-4 my-5 cursor-pointer">
             My <span className="text-red-500">RealEstate</span>
        </h2>
      </Link>
    </div>
        ...
        <div className="h-full flex flex-col justify-center items-center">
          ...
          <ul className="text-white text-1xl">
            <li className="my-4" style={{ transition: `opacity ${menuTransitionDuration}ms ease-in-out` }}>
              <Link to="welcome" smooth={true} duration={500} onClick={handleMenuClick}>          
            ...
            <li className="my-4" style={{ transition: `opacity ${menuTransitionDuration + 100}ms ease-in-out` }}>
              <Link to="transaction" smooth={true} duration={500} onClick={handleMenuClick}>     
              <FaProjectDiagram className="inline mr-2" />           
                Transactions
              </Link>
            </li>          
            <li className="my-4" style={{ transition: `opacity ${menuTransitionDuration + 100}ms ease-in-out` }}>
              <button className="px-4 py-2 bg-gray-200 text-black rounded-md hover:bg-gray-500 hover:text-white mx-2"  onClick={handleLogout}>      
                  Log out
              </button>
            </li>
          </ul>
