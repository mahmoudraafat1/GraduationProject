...
const Features = () => {
  ...
  <span className="text-blue-500">Feature</span> <span className="text-white">Lands</span>
      ...
      {selectedProperty && (
        ...
        <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
          ...
          <h2 className="text-2xl font-semibold mb-5">Property Name : {selectedProperty.address}</h2>
